...
**Realizado por:**  
Camilo Andres Lopez Contreras  
Juan Jose Marquez Villareal  
...
donde $\varepsilon^2$ es un valor pequeño.
...
Se utiliza el integrador **Verlet de velocidad**, que presenta mejor estabilidad y conservación de energía que el método de Euler.

### Paso 1: Media velocidad
...
### Paso 2: Actualización de posición
...
Para evitar traslaciones globales del sistema, se transforma al marco donde:

- El centro de masa está en el origen.
- Su velocidad total es cero.

Esto mejora la estabilidad numérica y la visualización.
...
Sea $x(t)$ una serie temporal escalar.  
A partir de un histograma con probabilidades $p_i$, la Entropía de Shannon se define como:

$$
H = -\sum_{i=1}^{N} p_i \log_2(p_i)
$$

La versión normalizada en el intervalo $[0,1]$ es:
...
Es decir, la **distancia del cuerpo 0 al centro de masa (COM)**.
